...
export const Hero = () => {
  ...
  return (
    <section className="min-h-screen bg-white border-b-2 border-black grid-pattern flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20 relative">
      <div className="max-w-7xl mx-auto text-center z-10 w-full">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
          ...
          <button
            ...
            className="group flex items-center justify-center gap-2 px-8 md:px-10 py-4 md:py-5 bg-neon-yellow text-black font-black border-2 border-black hover:bg-black hover:text-neon-yellow transition-all duration-200 text-base md:text-lg transform hover:scale-105"
          >
            VIEW WORK
          ...
          <a
            ...
            className="flex items-center justify-center gap-2 px-8 md:px-10 py-4 md:py-5 border-2 border-black text-black bg-white hover:bg-black hover:text-white font-black transition-all duration-200 text-base md:text-lg transform hover:scale-105"
          >
            GITHUB
